...
import {View,Image,StyleSheet,TouchableOpacity,Text,ScrollView,
        Dimensions,StatusBar,PermissionsAndroid,Alert,Platform,} from 'react-native';
import {RNCamera} from 'react-native-camera'; //tương tác với camera
import CameraRoll from '@react-native-community/cameraroll'; //lưu ảnh sau khi chụp vào thiết bị
...
export default function CaptureImage(props) {
    ...
    return (
        <View style={styles.container}>
                    ...
                    <TouchableOpacity
                        ...
                        {flash === 0 ? (
                            <Image
                                ...
                                source={require('../../assets/flashOff1.png')}/>
                        ) : flash === 1 ? (
                            <Image
                                style={styles.flashIcon}
            ...
            {/*danh sách ảnh sau khi chụp đươc */}
